...
class BaubleMaker(
    ...
    override fun run(): List<CSG> {
        ...
        val angle: ArrayList<Angle?> =
            arrayListOf(
                Angle(Angle.AngleDirection.Exact, 20.0),
                Angle(Angle.AngleDirection.Exact, -10.0),
            )
        val pOuter =
        ...
        val dockProfile =
            Profile.makeProfile(
                listOf(
                    listOf(0.0, designer.dockDiameter),
                    listOf(designer.dockLength, designer.dockDiameter),
