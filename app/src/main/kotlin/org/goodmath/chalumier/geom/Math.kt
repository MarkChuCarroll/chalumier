...
interface Math<T> {
    ...
    fun le(
        one: T,
        two: T,
    ): Boolean = this.lt(one, two) || this.eq(one, two)
    ...
    val selfBridge: MathBridge<T, T, T>
        get() {
            ...
            return object : MathBridge<T, T, T> {
                ...
                override fun rRecip(u: T): T = me.reciprocal(u)

                override fun neg(t: T): T = me.neg(t)

                override fun recip(t: T): T = prodMath.div(me.one, t)
                ...
                override fun rNeg(u: T): T = me.minus(me.zero, u)
